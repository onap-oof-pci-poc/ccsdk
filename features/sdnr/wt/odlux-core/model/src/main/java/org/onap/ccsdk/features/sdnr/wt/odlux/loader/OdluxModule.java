...
public class OdluxModule extends Module {

    final static Logger logger = LoggerFactory.getLogger(OdluxModule.class);
     ...
     */
    private OdluxModuleLoader loader;
    ...
    public void setLoader(OdluxModuleLoader loader) {
        this.loader = loader;
    }
