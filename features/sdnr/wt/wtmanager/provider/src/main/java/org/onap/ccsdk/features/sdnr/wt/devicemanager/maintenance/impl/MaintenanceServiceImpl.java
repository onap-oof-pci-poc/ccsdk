...
import org.onap.ccsdk.features.sdnr.wt.database.base.HtDataBaseReaderAndWriter;
...
import org.onap.ccsdk.features.sdnr.wt.devicemanager.impl.database.types.equipment.EsBaseRequireNetworkElement;
...
import org.opendaylight.yang.gen.v1.org.onap.ccsdk.features.sdnr.wt.wtmanager.rev190109.show.required.network.element.output.RequiredNetworkElementBuilder;
...
public class MaintenanceServiceImpl implements MaintenanceService, MaintenanceRPCServiceAPI, AutoCloseable {
     ...
     */
    private final HtDatabaseClientAbstract htDatabaseClientAbstract;
    ...
    public MaintenanceServiceImpl(HtDatabaseClientAbstract client) {
        ...
        htDatabaseClientAbstract = client;
        try {
    ...
    public void close() throws Exception {
        htDatabaseClientAbstract.close();
    }
