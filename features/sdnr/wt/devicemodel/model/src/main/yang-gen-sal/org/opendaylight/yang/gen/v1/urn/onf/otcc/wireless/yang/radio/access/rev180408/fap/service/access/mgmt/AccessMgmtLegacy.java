...
import org.opendaylight.yang.gen.v1.urn.onf.otcc.wireless.yang.radio.access.rev180408.AccessMgmtLegacyG;
 ...
 * <i>bbf-tr-196-2-0-3-full/fap-service/access-mgmt/access-mgmt-legacy</i>
 *
 * <p>To create instances of this class use {@link AccessMgmtLegacyBuilder}.
 * @see AccessMgmtLegacyBuilder
 *
 */
public interface AccessMgmtLegacy
    extends
    ChildOf<AccessMgmt>,
    Augmentable<org.opendaylight.yang.gen.v1.urn.onf.otcc.wireless.yang.radio.access.rev180408.fap.service.access.mgmt.AccessMgmtLegacy>,
    AccessMgmtLegacyG
{
    ...
    public static final QName QNAME = org.opendaylight.yangtools.yang.common.QName.create("urn:onf:otcc:wireless:yang:radio-access",
        "2018-04-08", "access-mgmt-legacy").intern();
     ...
     *
     *
     * @return <code>org.opendaylight.yang.gen.v1.urn.onf.otcc.wireless.yang.radio.access.rev180408.fap.service.access.mgmt.access.mgmt.legacy.AccessMgmtLegacyLocalIpAccess</code> <code>accessMgmtLegacyLocalIpAccess</code>, or <code>null</code> if not present
     */
    AccessMgmtLegacyLocalIpAccess getAccessMgmtLegacyLocalIpAccess();
