 ...
 * <i>onf-ethernet-conditional-packages/ethernet-historical-performances-g</i>
 *
 */
public interface EthernetHistoricalPerformancesG
    extends
    DataObject
{
    ...
    public static final QName QNAME = org.opendaylight.yangtools.yang.common.QName.create("urn:onf:params:xml:ns:yang:onf-ethernet-conditional-packages",
        "2017-04-02", "ethernet-historical-performances-g").intern();
