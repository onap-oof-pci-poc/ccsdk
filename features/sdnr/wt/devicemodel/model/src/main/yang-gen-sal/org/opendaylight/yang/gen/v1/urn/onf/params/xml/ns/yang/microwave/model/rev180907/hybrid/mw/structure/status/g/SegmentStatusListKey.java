...
public class SegmentStatusListKey
 implements Identifier<SegmentStatusList> {
    ...
    public java.lang.String toString() {
        java.lang.StringBuilder builder = new java.lang.StringBuilder(org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev180907.hybrid.mw.structure.status.g.SegmentStatusListKey.class.getSimpleName()).append(" [");
        boolean first = true;
