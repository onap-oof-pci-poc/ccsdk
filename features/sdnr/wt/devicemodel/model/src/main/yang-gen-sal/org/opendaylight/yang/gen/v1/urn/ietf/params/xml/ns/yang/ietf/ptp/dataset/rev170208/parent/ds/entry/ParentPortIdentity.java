 ...
 * <i>ietf-ptp-dataset/parent-ds-entry/parent-port-identity</i>
 *
 * <p>To create instances of this class use {@link ParentPortIdentityBuilder}.
 * @see ParentPortIdentityBuilder
 *
 */
public interface ParentPortIdentity
    extends
    ChildOf<ParentDsEntry>,
    Augmentable<org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.ietf.ptp.dataset.rev170208.parent.ds.entry.ParentPortIdentity>,
    PortIdentityGrouping
{
    ...
    public static final QName QNAME = org.opendaylight.yangtools.yang.common.QName.create("urn:ietf:params:xml:ns:yang:ietf-ptp-dataset",
        "2017-02-08", "parent-port-identity").intern();
