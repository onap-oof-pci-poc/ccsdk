...
import org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev181010.TdmContainerTypeG;
...
public interface SupportedTdmContainerTypesList
    ...
    Augmentable<org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev181010.tdm.container.capability.g.SupportedTdmContainerTypesList>,
    TdmContainerTypeG,
    Identifiable<SupportedTdmContainerTypesListKey>
{
    ...
    public static final QName QNAME = org.opendaylight.yangtools.yang.common.QName.create("urn:onf:params:xml:ns:yang:microwave-model",
        "2018-10-10", "supported-tdm-container-types-list").intern();
     ...
     *
     *
     * @return <code>org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev181010.tdm.container.capability.g.SupportedTdmContainerTypesListKey</code> <code>key</code>, or <code>null</code> if not present
     */
