    ...
    DataObject
{
    ...
    public static final QName QNAME = org.opendaylight.yangtools.yang.common.QName.create("urn:onf:params:xml:ns:yang:microwave-model",
        "2018-09-07", "air-interface-configuration-g").intern();
     ...
     *
     *
     * @return <code>java.lang.String</code> <code>remoteAirInterfaceName</code>, or <code>null</code> if not present
     */
    java.lang.String getRemoteAirInterfaceName();
    
    /**
     * If set on '0', the receiver ignores the signal ID of the received signal. If set
     * on any other value, the receiver exclusively synchronizes on signals with the 
     * same signal ID.
     *
     *
     *
     * @return <code>java.lang.Short</code> <code>expectedSignalId</code>, or <code>null</code> if not present
     */
    java.lang.Short getExpectedSignalId();
    
    /**
     * Transmitted radio signal ID for synchronizing the receiver.
     *
     *
     *
     * @return <code>java.lang.Short</code> <code>transmittedSignalId</code>, or <code>null</code> if not present
     */
    java.lang.Short getTransmittedSignalId();
    ...
    /**
     * Minimum transmission mode to be configured (in case adaptive modulation is not 
     * used, this value represents also the fixed transmission mode).
     *
     *
     *
     * @return <code>org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.core.model.rev170320.UniversalId</code> <code>transmissionModeMin</code>, or <code>null</code> if not present
     */
    UniversalId getTransmissionModeMin();
     ...
     *
     *
     * @return <code>org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.core.model.rev170320.UniversalId</code> <code>transmissionModeMax</code>, or <code>null</code> if not present
     */
    UniversalId getTransmissionModeMax();
     ...
     *
     *
     * @return <code>org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev180907.PolarizationType</code> <code>polarization</code>, or <code>null</code> if not present
     */
     ...
     *
     *
     * @return <code>java.lang.Byte</code> <code>atpcTxPowerMin</code>, or <code>null</code> if not present
     */
    java.lang.Byte getAtpcTxPowerMin();
     ...
     *
     *
     * @return <code>org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev180907.LoopBackType</code> <code>loopBackKindOn</code>, or <code>null</code> if not present
     */
