...
/**
 * This module contains a collection of YANG definitions for managing radio access 
 * network (RAN) devices.
 *
 * <p>
 ...
 *     revision 2018-04-08 {
 *         description "This module contains a collection of YANG definitions for managing radio access 
 *                     network (RAN) devices.
 *         ";
 *     }
 *
 ...
 *
 */
public interface BbfTr196203FullData
    extends
    DataRoot
{
     ...
     *
     *
     * @return <code>java.util.List</code> <code>fapService</code>, or <code>null</code> if not present
     */
    List<FapService> getFapService();
