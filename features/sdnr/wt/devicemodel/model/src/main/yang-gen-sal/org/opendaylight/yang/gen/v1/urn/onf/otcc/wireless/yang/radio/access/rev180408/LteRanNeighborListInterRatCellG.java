 ...
 * <i>bbf-tr-196-2-0-3-full/lte-ran-neighbor-list-inter-rat-cell-g</i>
 *
 */
public interface LteRanNeighborListInterRatCellG
    extends
    DataObject
{
    ...
    public static final QName QNAME = org.opendaylight.yangtools.yang.common.QName.create("urn:onf:otcc:wireless:yang:radio-access",
        "2018-04-08", "lte-ran-neighbor-list-inter-rat-cell-g").intern();

    /**
     * The maximum number of entries in the 
     * {{object|.CellConfig.LTE.RAN.NeighborList.InterRATCell.UMTS.{i}.}} table. There 
     * can be maximum of 16 UTRAN (UMTS) neighbor cells, as specified by 
    ...
    /**
     * The maximum number of entries in the 
     * {{object|.CellConfig.LTE.RAN.NeighborList.InterRATCell.GSM.{i}.}} table. There 
     * can be maximum of 16 GERAN (GSM) neighbor cells, as specified by 
    ...
    /**
     * The maximum number of entries in the 
     * {{object|.CellConfig.LTE.RAN.NeighborList.InterRATCell.CDMA2000.{i}.}} table. 
     * There can be maximum of 32 bandclasses. In each bandclass, there can be maximum 
     * of 16 CDMA2000 carrier frequencies. In each carrier, there can be maximum of 16 
     * CDMA2000 neighbor cells (PN offset). It is specified by neighCellList in SIB8 in
