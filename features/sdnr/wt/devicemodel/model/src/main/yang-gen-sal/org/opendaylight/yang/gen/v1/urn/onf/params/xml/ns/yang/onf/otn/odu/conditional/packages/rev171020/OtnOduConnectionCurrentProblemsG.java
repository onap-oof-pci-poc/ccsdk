 ...
 * <i>onf-otn-odu-conditional-packages/otn-odu-connection-current-problems-g</i>
 *
 */
public interface OtnOduConnectionCurrentProblemsG
    extends
    DataObject
{
    ...
    public static final QName QNAME = org.opendaylight.yangtools.yang.common.QName.create("urn:onf:params:xml:ns:yang:onf-otn-odu-conditional-packages",
        "2017-10-20", "otn-odu-connection-current-problems-g").intern();
