...
import org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.onf.otn.odu.conditional.packages.rev171020.OtnOduTerminationStatusG;
 ...
 * <i>onf-otn-odu-conditional-packages/otn-odu-termination-pac/otn-odu-termination-status</i>
 *
 * <p>To create instances of this class use {@link OtnOduTerminationStatusBuilder}.
 * @see OtnOduTerminationStatusBuilder
 *
 */
public interface OtnOduTerminationStatus
    extends
    ChildOf<OtnOduTerminationPac>,
    Augmentable<org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.onf.otn.odu.conditional.packages.rev171020.otn.odu.termination.pac.OtnOduTerminationStatus>,
    OtnOduTerminationStatusG
{
    ...
    public static final QName QNAME = org.opendaylight.yangtools.yang.common.QName.create("urn:onf:params:xml:ns:yang:onf-otn-odu-conditional-packages",
        "2017-10-20", "otn-odu-termination-status").intern();
