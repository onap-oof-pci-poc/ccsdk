...
public interface MwAirInterfaceDiversityPac
    ...
    Augmentable<org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev170324.MwAirInterfaceDiversityPac>,
    Identifiable<MwAirInterfaceDiversityPacKey>
{
    ...
    public static final QName QNAME = org.opendaylight.yangtools.yang.common.QName.create("urn:onf:params:xml:ns:yang:microwave-model",
        "2017-03-24", "mw-air-interface-diversity-pac").intern();
     ...
     *
     *
     * @return <code>org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev170324.mw.air._interface.diversity.pac.AirInterfaceDiversityCapability</code> <code>airInterfaceDiversityCapability</code>, or <code>null</code> if not present
     */
     ...
     *
     *
     * @return <code>org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev170324.mw.air._interface.diversity.pac.AirInterfaceDiversityConfiguration</code> <code>airInterfaceDiversityConfiguration</code>, or <code>null</code> if not present
     */
     ...
     *
     *
     * @return <code>org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev170324.mw.air._interface.diversity.pac.AirInterfaceDiversityStatus</code> <code>airInterfaceDiversityStatus</code>, or <code>null</code> if not present
     */
     ...
     *
     *
     * @return <code>org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev170324.mw.air._interface.diversity.pac.AirInterfaceDiversityCurrentProblems</code> <code>airInterfaceDiversityCurrentProblems</code>, or <code>null</code> if not present
     */
     ...
     *
     *
     * @return <code>org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev170324.mw.air._interface.diversity.pac.AirInterfaceDiversityCurrentPerformance</code> <code>airInterfaceDiversityCurrentPerformance</code>, or <code>null</code> if not present
     */
     ...
     *
     *
     * @return <code>org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev170324.mw.air._interface.diversity.pac.AirInterfaceDiversityHistoricalPerformances</code> <code>airInterfaceDiversityHistoricalPerformances</code>, or <code>null</code> if not present
     */
     ...
     *
     *
     * @return <code>org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev170324.MwAirInterfaceDiversityPacKey</code> <code>key</code>, or <code>null</code> if not present
     */
