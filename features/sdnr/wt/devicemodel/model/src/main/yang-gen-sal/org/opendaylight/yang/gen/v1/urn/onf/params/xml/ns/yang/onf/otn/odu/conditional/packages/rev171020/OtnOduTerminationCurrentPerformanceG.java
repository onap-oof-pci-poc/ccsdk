 ...
 * <i>onf-otn-odu-conditional-packages/otn-odu-termination-current-performance-g</i>
 *
 */
public interface OtnOduTerminationCurrentPerformanceG
    extends
    DataObject
{
    ...
    public static final QName QNAME = org.opendaylight.yangtools.yang.common.QName.create("urn:onf:params:xml:ns:yang:onf-otn-odu-conditional-packages",
        "2017-10-20", "otn-odu-termination-current-performance-g").intern();
