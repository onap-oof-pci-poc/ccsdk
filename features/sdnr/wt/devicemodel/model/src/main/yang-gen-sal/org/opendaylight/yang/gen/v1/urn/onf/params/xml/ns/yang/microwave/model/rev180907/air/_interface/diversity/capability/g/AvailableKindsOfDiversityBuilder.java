...
/**
 * Class that builds {@link org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev180907.air._interface.diversity.capability.g.AvailableKindsOfDiversity} instances.
 *
 * @see org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev180907.air._interface.diversity.capability.g.AvailableKindsOfDiversity
 *
 */
public class AvailableKindsOfDiversityBuilder implements Builder<org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev180907.air._interface.diversity.capability.g.AvailableKindsOfDiversity> {
    ...
    public AvailableKindsOfDiversityBuilder(org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev180907.DiversityTypeG arg) {
    ...
    public AvailableKindsOfDiversityBuilder(AvailableKindsOfDiversity base) {
        ...
        if (base instanceof AvailableKindsOfDiversityImpl) {
            ...
            AugmentationHolder<org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev180907.air._interface.diversity.capability.g.AvailableKindsOfDiversity> casted =(AugmentationHolder<org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev180907.air._interface.diversity.capability.g.AvailableKindsOfDiversity>) base;
    ...
    */
    ...
    @SuppressWarnings("unchecked")
    public <E extends Augmentation<org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev180907.air._interface.diversity.capability.g.AvailableKindsOfDiversity>> E getAugmentation(java.lang.Class<E> augmentationType) {
    ...
    public AvailableKindsOfDiversityBuilder addAugmentation(java.lang.Class<? extends Augmentation<org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev180907.air._interface.diversity.capability.g.AvailableKindsOfDiversity>> augmentationType, Augmentation<org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev180907.air._interface.diversity.capability.g.AvailableKindsOfDiversity> augmentationValue) {
    ...
    public AvailableKindsOfDiversityBuilder removeAugmentation(java.lang.Class<? extends Augmentation<org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev180907.air._interface.diversity.capability.g.AvailableKindsOfDiversity>> augmentationType) {
        if (this.augmentation instanceof HashMap) {
    ...
    private static final class AvailableKindsOfDiversityImpl implements AvailableKindsOfDiversity {
        ...
        @Override
        public java.lang.Class<org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev180907.air._interface.diversity.capability.g.AvailableKindsOfDiversity> getImplementedInterface() {
            return org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev180907.air._interface.diversity.capability.g.AvailableKindsOfDiversity.class;
        }
        ...
        public boolean equals(java.lang.Object obj) {
            ...
            if (!org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev180907.air._interface.diversity.capability.g.AvailableKindsOfDiversity.class.equals(((DataObject)obj).getImplementedInterface())) {
                return false;
            }
            org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev180907.air._interface.diversity.capability.g.AvailableKindsOfDiversity other = (org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev180907.air._interface.diversity.capability.g.AvailableKindsOfDiversity)obj;
