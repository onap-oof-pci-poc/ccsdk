 ...
 * <i>microwave-model/wire-interface-current-problems-g</i>
 *
 */
public interface WireInterfaceCurrentProblemsG
    extends
    DataObject
{
    ...
    public static final QName QNAME = org.opendaylight.yangtools.yang.common.QName.create("urn:onf:params:xml:ns:yang:microwave-model",
        "2018-10-10", "wire-interface-current-problems-g").intern();
