...
/**
 * Table containing the inter-RAT cell list for UTRA (UMTS) provided by the ACS. 
 ...
 * <i>bbf-tr-196-2-0-3-full/lte-ran-neighbor-list-inter-rat-cell-umts-g</i>
 *
 */
public interface LteRanNeighborListInterRatCellUmtsG
    extends
    DataObject
{
    ...
    public static final QName QNAME = org.opendaylight.yangtools.yang.common.QName.create("urn:onf:otcc:wireless:yang:radio-access",
        "2018-04-08", "lte-ran-neighbor-list-inter-rat-cell-umts-g").intern();
    ...
    /**
     * RNC-ID of an intra-RAT UMTS neighbor cell. It uniquely identifies an RNC within 
     * a PLMN. Normally, RNC-ID consists of 12 bits (i.e. a range of [0:4095]). 
     * However, if the value is larger than 4095, then Extended RNC-ID (range of 
     * [4096:65535]) is used in RANAP. The RNC-ID and Extended RNC-ID are combined into
     * a single parameter here as there is no explicit need to have them separated. 
