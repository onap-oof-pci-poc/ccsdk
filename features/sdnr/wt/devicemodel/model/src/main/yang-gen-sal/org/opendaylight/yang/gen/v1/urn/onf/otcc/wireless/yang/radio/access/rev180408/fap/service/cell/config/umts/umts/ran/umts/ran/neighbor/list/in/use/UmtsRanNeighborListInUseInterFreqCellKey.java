...
public class UmtsRanNeighborListInUseInterFreqCellKey
 implements Identifier<UmtsRanNeighborListInUseInterFreqCell> {
    private static final long serialVersionUID = -2700486766057859289L;
    private final java.lang.Integer _uarfcndl;
    private final java.lang.Integer _pcpichScramblingCode;


    public UmtsRanNeighborListInUseInterFreqCellKey(java.lang.Integer _pcpichScramblingCode, java.lang.Integer _uarfcndl) {
     ...
     */
    public UmtsRanNeighborListInUseInterFreqCellKey(UmtsRanNeighborListInUseInterFreqCellKey source) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        UmtsRanNeighborListInUseInterFreqCellKey other = (UmtsRanNeighborListInUseInterFreqCellKey) obj;
    ...
    public java.lang.String toString() {
        java.lang.StringBuilder builder = new java.lang.StringBuilder(org.opendaylight.yang.gen.v1.urn.onf.otcc.wireless.yang.radio.access.rev180408.fap.service.cell.config.umts.umts.ran.umts.ran.neighbor.list.in.use.UmtsRanNeighborListInUseInterFreqCellKey.class.getSimpleName()).append(" [");
        boolean first = true;
