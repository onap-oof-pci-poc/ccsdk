...
/**
 * Class that builds {@link org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev180907.air._interface.diversity.configuration.g.ThresholdCrossAlarmList} instances.
 *
 * @see org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev180907.air._interface.diversity.configuration.g.ThresholdCrossAlarmList
 *
 */
public class ThresholdCrossAlarmListBuilder implements Builder<org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev180907.air._interface.diversity.configuration.g.ThresholdCrossAlarmList> {
    ...
    public ThresholdCrossAlarmListBuilder(ThresholdCrossAlarmList base) {
        ...
        if (base instanceof ThresholdCrossAlarmListImpl) {
            ...
            AugmentationHolder<org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev180907.air._interface.diversity.configuration.g.ThresholdCrossAlarmList> casted =(AugmentationHolder<org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev180907.air._interface.diversity.configuration.g.ThresholdCrossAlarmList>) base;
    ...
    */
    ...
    @SuppressWarnings("unchecked")
    public <E extends Augmentation<org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev180907.air._interface.diversity.configuration.g.ThresholdCrossAlarmList>> E getAugmentation(java.lang.Class<E> augmentationType) {
    ...
    public ThresholdCrossAlarmListBuilder addAugmentation(java.lang.Class<? extends Augmentation<org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev180907.air._interface.diversity.configuration.g.ThresholdCrossAlarmList>> augmentationType, Augmentation<org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev180907.air._interface.diversity.configuration.g.ThresholdCrossAlarmList> augmentationValue) {
    ...
    public ThresholdCrossAlarmListBuilder removeAugmentation(java.lang.Class<? extends Augmentation<org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev180907.air._interface.diversity.configuration.g.ThresholdCrossAlarmList>> augmentationType) {
        if (this.augmentation instanceof HashMap) {
    ...
    private static final class ThresholdCrossAlarmListImpl implements ThresholdCrossAlarmList {
        ...
        @Override
        public java.lang.Class<org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev180907.air._interface.diversity.configuration.g.ThresholdCrossAlarmList> getImplementedInterface() {
            return org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev180907.air._interface.diversity.configuration.g.ThresholdCrossAlarmList.class;
        }
        ...
        public boolean equals(java.lang.Object obj) {
            ...
            if (!org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev180907.air._interface.diversity.configuration.g.ThresholdCrossAlarmList.class.equals(((DataObject)obj).getImplementedInterface())) {
                return false;
            }
            org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev180907.air._interface.diversity.configuration.g.ThresholdCrossAlarmList other = (org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev180907.air._interface.diversity.configuration.g.ThresholdCrossAlarmList)obj;
