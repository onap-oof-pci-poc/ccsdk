 ...
 * <i>onf-core-model-conditional-packages/network-element-configuration-g/problem-type-severity-list</i>
 *
...
public interface ProblemTypeSeverityList
    extends
    ChildOf<NetworkElementConfigurationG>,
    Augmentable<org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.onf.core.model.conditional.packages.rev170402.network.element.configuration.g.ProblemTypeSeverityList>,
    ...
    Identifiable<ProblemTypeSeverityListKey>
{
     ...
     *
     *
     * @return <code>org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.onf.core.model.conditional.packages.rev170402.network.element.configuration.g.ProblemTypeSeverityListKey</code> <code>key</code>, or <code>null</code> if not present
     */
