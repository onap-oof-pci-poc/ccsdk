...
import org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.onf.core.model.conditional.packages.rev170402.EquipmentCapabilityG;
 ...
 * <i>onf-core-model-conditional-packages/equipment-pac/equipment-capability</i>
 *
 * <p>To create instances of this class use {@link EquipmentCapabilityBuilder}.
 * @see EquipmentCapabilityBuilder
 *
 */
public interface EquipmentCapability
    extends
    ChildOf<EquipmentPac>,
    Augmentable<org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.onf.core.model.conditional.packages.rev170402.equipment.pac.EquipmentCapability>,
    EquipmentCapabilityG
{
    ...
    public static final QName QNAME = org.opendaylight.yangtools.yang.common.QName.create("urn:onf:params:xml:ns:yang:onf-core-model-conditional-packages",
        "2017-04-02", "equipment-capability").intern();
