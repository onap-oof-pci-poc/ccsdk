...
/**
 * Class that builds {@link org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev181010.wire._interface.historical.performances.g.HistoricalPerformanceDataList} instances.
 *
 * @see org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev181010.wire._interface.historical.performances.g.HistoricalPerformanceDataList
 *
 */
public class HistoricalPerformanceDataListBuilder implements Builder<org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev181010.wire._interface.historical.performances.g.HistoricalPerformanceDataList> {
    ...
    Map<java.lang.Class<? extends Augmentation<org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev181010.wire._interface.historical.performances.g.HistoricalPerformanceDataList>>, Augmentation<org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev181010.wire._interface.historical.performances.g.HistoricalPerformanceDataList>> augmentation = Collections.emptyMap();

    public HistoricalPerformanceDataListBuilder() {
    }
    public HistoricalPerformanceDataListBuilder(org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev181010.WireInterfaceHistoricalPerformanceTypeG arg) {
    ...
    public HistoricalPerformanceDataListBuilder(HistoricalPerformanceDataList base) {
        ...
        if (base instanceof HistoricalPerformanceDataListImpl) {
            ...
            AugmentationHolder<org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev181010.wire._interface.historical.performances.g.HistoricalPerformanceDataList> casted =(AugmentationHolder<org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev181010.wire._interface.historical.performances.g.HistoricalPerformanceDataList>) base;
     ...
     * <li>org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev181010.WireInterfaceHistoricalPerformanceTypeG</li>
    ...
    */
    public void fieldsFrom(DataObject arg) {
        ...
        if (arg instanceof org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev181010.WireInterfaceHistoricalPerformanceTypeG) {
            this._performanceData = ((org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev181010.WireInterfaceHistoricalPerformanceTypeG)arg).getPerformanceData();
            isValidArg = true;
        }
        ...
        if (!isValidArg) {
            throw new IllegalArgumentException(
              "expected one of: [org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.g._874._1.model.rev170320.Q822HistoryDataG, org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev181010.WireInterfaceHistoricalPerformanceTypeG, org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.g._874._1.model.rev170320.OtnHistoryDataG, org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.g._874._1.model.rev170320.X721TopG] \n" +
              "but was: " + arg
            );
        }
    }
    ...
    @SuppressWarnings("unchecked")
    public <E extends Augmentation<org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev181010.wire._interface.historical.performances.g.HistoricalPerformanceDataList>> E getAugmentation(java.lang.Class<E> augmentationType) {
    ...
    public HistoricalPerformanceDataListBuilder addAugmentation(java.lang.Class<? extends Augmentation<org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev181010.wire._interface.historical.performances.g.HistoricalPerformanceDataList>> augmentationType, Augmentation<org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev181010.wire._interface.historical.performances.g.HistoricalPerformanceDataList> augmentationValue) {
    ...
    public HistoricalPerformanceDataListBuilder removeAugmentation(java.lang.Class<? extends Augmentation<org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev181010.wire._interface.historical.performances.g.HistoricalPerformanceDataList>> augmentationType) {
        if (this.augmentation instanceof HashMap) {
    ...
    private static final class HistoricalPerformanceDataListImpl implements HistoricalPerformanceDataList {
        ...
        @Override
        public java.lang.Class<org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev181010.wire._interface.historical.performances.g.HistoricalPerformanceDataList> getImplementedInterface() {
            return org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev181010.wire._interface.historical.performances.g.HistoricalPerformanceDataList.class;
        }
        ...
        private Map<java.lang.Class<? extends Augmentation<org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev181010.wire._interface.historical.performances.g.HistoricalPerformanceDataList>>, Augmentation<org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev181010.wire._interface.historical.performances.g.HistoricalPerformanceDataList>> augmentation = Collections.emptyMap();
        ...
        private HistoricalPerformanceDataListImpl(HistoricalPerformanceDataListBuilder base) {
            ...
            case 0:
                ...
                break;
            case 1:
                final Map.Entry<java.lang.Class<? extends Augmentation<org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev181010.wire._interface.historical.performances.g.HistoricalPerformanceDataList>>, Augmentation<org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev181010.wire._interface.historical.performances.g.HistoricalPerformanceDataList>> e = base.augmentation.entrySet().iterator().next();
                this.augmentation = Collections.<java.lang.Class<? extends Augmentation<org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev181010.wire._interface.historical.performances.g.HistoricalPerformanceDataList>>, Augmentation<org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev181010.wire._interface.historical.performances.g.HistoricalPerformanceDataList>>singletonMap(e.getKey(), e.getValue());
                break;
            default :
        ...
        public boolean equals(java.lang.Object obj) {
            ...
            if (!org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev181010.wire._interface.historical.performances.g.HistoricalPerformanceDataList.class.equals(((DataObject)obj).getImplementedInterface())) {
                return false;
            }
            org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev181010.wire._interface.historical.performances.g.HistoricalPerformanceDataList other = (org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev181010.wire._interface.historical.performances.g.HistoricalPerformanceDataList)obj;
            ...
            if (getClass() == obj.getClass()) {
                ...
                for (Map.Entry<java.lang.Class<? extends Augmentation<org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev181010.wire._interface.historical.performances.g.HistoricalPerformanceDataList>>, Augmentation<org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev181010.wire._interface.historical.performances.g.HistoricalPerformanceDataList>> e : augmentation.entrySet()) {
