 ...
 * <i>onf-core-model-conditional-packages/connector-configuration-g/problem-type-severity-list</i>
 *
...
public interface ProblemTypeSeverityList
    extends
    ChildOf<ConnectorConfigurationG>,
    Augmentable<org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.onf.core.model.conditional.packages.rev170402.connector.configuration.g.ProblemTypeSeverityList>,
    ...
    Identifiable<ProblemTypeSeverityListKey>
{
     ...
     *
     *
     * @return <code>org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.onf.core.model.conditional.packages.rev170402.connector.configuration.g.ProblemTypeSeverityListKey</code> <code>key</code>, or <code>null</code> if not present
     */
