    ...
    DataObject
{
    ...
    public static final QName QNAME = org.opendaylight.yangtools.yang.common.QName.create("urn:onf:params:xml:ns:yang:microwave-model",
        "2018-10-10", "air-interface-performance-type-g").intern();
     ...
     *
     *
     * @return <code>java.util.List</code> <code>timeXStatesList</code>, or <code>null</code> if not present
     */
    List<TimeXStatesList> getTimeXStatesList();
