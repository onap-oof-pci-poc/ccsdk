 ...
 * <i>microwave-model/wire-interface-current-problem-type-g</i>
 *
 */
public interface WireInterfaceCurrentProblemTypeG
    extends
    DataObject,
    MwCurrentProblemG
{
    ...
    public static final QName QNAME = org.opendaylight.yangtools.yang.common.QName.create("urn:onf:params:xml:ns:yang:microwave-model",
        "2018-10-10", "wire-interface-current-problem-type-g").intern();
