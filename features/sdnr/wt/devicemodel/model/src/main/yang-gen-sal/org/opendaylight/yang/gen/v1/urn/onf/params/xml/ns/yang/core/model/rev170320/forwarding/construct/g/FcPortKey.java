...
public class FcPortKey
 implements Identifier<FcPort> {
    private static final long serialVersionUID = 6511009767252418784L;
    private final UniversalId _uuid;


    public FcPortKey(UniversalId _uuid) {
    ...
    public java.lang.String toString() {
        java.lang.StringBuilder builder = new java.lang.StringBuilder(org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.core.model.rev170320.forwarding.construct.g.FcPortKey.class.getSimpleName()).append(" [");
        boolean first = true;
