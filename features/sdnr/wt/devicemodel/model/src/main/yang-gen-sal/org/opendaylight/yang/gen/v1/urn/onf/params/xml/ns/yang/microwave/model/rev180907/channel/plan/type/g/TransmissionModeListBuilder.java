...
/**
 * Class that builds {@link org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev180907.channel.plan.type.g.TransmissionModeList} instances.
 *
 * @see org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev180907.channel.plan.type.g.TransmissionModeList
 *
 */
public class TransmissionModeListBuilder implements Builder<org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev180907.channel.plan.type.g.TransmissionModeList> {
    ...
    Map<java.lang.Class<? extends Augmentation<org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev180907.channel.plan.type.g.TransmissionModeList>>, Augmentation<org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev180907.channel.plan.type.g.TransmissionModeList>> augmentation = Collections.emptyMap();

    public TransmissionModeListBuilder() {
    }
    public TransmissionModeListBuilder(org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev180907.TransmissionModeTypeG arg) {
    ...
    public TransmissionModeListBuilder(TransmissionModeList base) {
        ...
        if (base instanceof TransmissionModeListImpl) {
            ...
            AugmentationHolder<org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev180907.channel.plan.type.g.TransmissionModeList> casted =(AugmentationHolder<org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev180907.channel.plan.type.g.TransmissionModeList>) base;
     ...
     * <ul>
     * <li>org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev180907.TransmissionModeTypeG</li>
     * </ul>
     *
    ...
    */
    public void fieldsFrom(DataObject arg) {
        ...
        if (arg instanceof org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev180907.TransmissionModeTypeG) {
            this._transmissionModeId = ((org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev180907.TransmissionModeTypeG)arg).getTransmissionModeId();
            this._transmissionModeName = ((org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev180907.TransmissionModeTypeG)arg).getTransmissionModeName();
            this._channelBandwidth = ((org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev180907.TransmissionModeTypeG)arg).getChannelBandwidth();
            this._modulationScheme = ((org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev180907.TransmissionModeTypeG)arg).getModulationScheme();
            this._codeRate = ((org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev180907.TransmissionModeTypeG)arg).getCodeRate();
            this._symbolRateReductionFactor = ((org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev180907.TransmissionModeTypeG)arg).getSymbolRateReductionFactor();
            this._txPowerMin = ((org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev180907.TransmissionModeTypeG)arg).getTxPowerMin();
            this._txPowerMax = ((org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev180907.TransmissionModeTypeG)arg).getTxPowerMax();
            this._rxThreshold = ((org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev180907.TransmissionModeTypeG)arg).getRxThreshold();
            this._amUpshiftLevel = ((org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev180907.TransmissionModeTypeG)arg).getAmUpshiftLevel();
            this._amDownshiftLevel = ((org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev180907.TransmissionModeTypeG)arg).getAmDownshiftLevel();
            this._xpicIsAvail = ((org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev180907.TransmissionModeTypeG)arg).isXpicIsAvail();
            isValidArg = true;
        }
        if (!isValidArg) {
            throw new IllegalArgumentException(
              "expected one of: [org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev180907.TransmissionModeTypeG] \n" +
              "but was: " + arg
            );
        }
    }
    ...
    @SuppressWarnings("unchecked")
    public <E extends Augmentation<org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev180907.channel.plan.type.g.TransmissionModeList>> E getAugmentation(java.lang.Class<E> augmentationType) {
    ...
    public TransmissionModeListBuilder addAugmentation(java.lang.Class<? extends Augmentation<org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev180907.channel.plan.type.g.TransmissionModeList>> augmentationType, Augmentation<org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev180907.channel.plan.type.g.TransmissionModeList> augmentationValue) {
    ...
    public TransmissionModeListBuilder removeAugmentation(java.lang.Class<? extends Augmentation<org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev180907.channel.plan.type.g.TransmissionModeList>> augmentationType) {
        if (this.augmentation instanceof HashMap) {
    ...
    private static final class TransmissionModeListImpl implements TransmissionModeList {
        ...
        @Override
        public java.lang.Class<org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev180907.channel.plan.type.g.TransmissionModeList> getImplementedInterface() {
            return org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev180907.channel.plan.type.g.TransmissionModeList.class;
        }
        ...
        private Map<java.lang.Class<? extends Augmentation<org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev180907.channel.plan.type.g.TransmissionModeList>>, Augmentation<org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev180907.channel.plan.type.g.TransmissionModeList>> augmentation = Collections.emptyMap();
        ...
        private TransmissionModeListImpl(TransmissionModeListBuilder base) {
            ...
            case 0:
                ...
                break;
            case 1:
                final Map.Entry<java.lang.Class<? extends Augmentation<org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev180907.channel.plan.type.g.TransmissionModeList>>, Augmentation<org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev180907.channel.plan.type.g.TransmissionModeList>> e = base.augmentation.entrySet().iterator().next();
                this.augmentation = Collections.<java.lang.Class<? extends Augmentation<org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev180907.channel.plan.type.g.TransmissionModeList>>, Augmentation<org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev180907.channel.plan.type.g.TransmissionModeList>>singletonMap(e.getKey(), e.getValue());
                break;
            default :
        ...
        public boolean equals(java.lang.Object obj) {
            ...
            if (!org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev180907.channel.plan.type.g.TransmissionModeList.class.equals(((DataObject)obj).getImplementedInterface())) {
                return false;
            }
            org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev180907.channel.plan.type.g.TransmissionModeList other = (org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev180907.channel.plan.type.g.TransmissionModeList)obj;
            ...
            if (getClass() == obj.getClass()) {
                ...
                for (Map.Entry<java.lang.Class<? extends Augmentation<org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev180907.channel.plan.type.g.TransmissionModeList>>, Augmentation<org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev180907.channel.plan.type.g.TransmissionModeList>> e : augmentation.entrySet()) {
