...
import org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.onf.ethernet.conditional.packages.rev170402.EthernetCapabilityG;
 ...
 * <i>onf-ethernet-conditional-packages/ethernet-pac/ethernet-capability</i>
 *
 * <p>To create instances of this class use {@link EthernetCapabilityBuilder}.
 * @see EthernetCapabilityBuilder
 *
 */
public interface EthernetCapability
    extends
    ChildOf<EthernetPac>,
    Augmentable<org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.onf.ethernet.conditional.packages.rev170402.ethernet.pac.EthernetCapability>,
    EthernetCapabilityG
{
    ...
    public static final QName QNAME = org.opendaylight.yangtools.yang.common.QName.create("urn:onf:params:xml:ns:yang:onf-ethernet-conditional-packages",
        "2017-04-02", "ethernet-capability").intern();
