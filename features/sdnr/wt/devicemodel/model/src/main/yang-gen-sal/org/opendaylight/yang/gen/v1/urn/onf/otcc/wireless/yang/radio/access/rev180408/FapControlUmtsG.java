 ...
 * <i>bbf-tr-196-2-0-3-full/fap-control-umts-g</i>
 *
 */
public interface FapControlUmtsG
    extends
    DataObject
{
    ...
    public static final QName QNAME = org.opendaylight.yangtools.yang.common.QName.create("urn:onf:otcc:wireless:yang:radio-access",
        "2018-04-08", "fap-control-umts-g").intern();

    /**
     * Current operational state of the UMTS FAP as defined in {{bibref|ITU-X.731}}. If
     * {{true}} the UMTS FAP is currently enabled. If {{false}} the UMTS FAP is 
     * currently disabled.
     *
     *
     *
    ...
    /**
     * Lock or unlock the UMTS FAP. This controls the administrative state of the UMTS 
     ...
     * UMTS FAP to state where it is NOT permitted to serve traffic. RF transmitter is 
     * disabled. Given that this command controls the UMTS FAP's RF transmitter, the 
     ...
     * regulatory requirements) # verifying the UMTS FAP configuration # if physical 
    ...
    /**
     * Current status of this UMTS FAP RF transmitter. {{true}} indicates that the UMTS
     * FAP Tx transmitter is on. {{false}} indicates that the UMTS FAP Tx transmitter 
     * is off. This state is tied to the Administrative state which is controlled by 
     * the ACS. :When the ACS sets {{param|AdminState}} to {{true}}, then the UMTS FAP 
     * has permission to turn on the RF transmitter. :When the ACS sets 
     * {{param|AdminState}} to {{false}}, then the UMTS FAP is not allowed to provide 
     ...
     * management related configuration for the UMTS FAP. In case of a 
