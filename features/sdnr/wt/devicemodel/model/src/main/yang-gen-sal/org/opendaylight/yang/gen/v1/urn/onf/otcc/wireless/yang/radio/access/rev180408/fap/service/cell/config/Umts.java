...
import org.opendaylight.yang.gen.v1.urn.onf.otcc.wireless.yang.radio.access.rev180408.UmtsG;
 ...
 * <i>bbf-tr-196-2-0-3-full/fap-service/cell-config/umts</i>
 *
 * <p>To create instances of this class use {@link UmtsBuilder}.
 * @see UmtsBuilder
 *
 */
public interface Umts
    extends
    ChildOf<CellConfig>,
    Augmentable<org.opendaylight.yang.gen.v1.urn.onf.otcc.wireless.yang.radio.access.rev180408.fap.service.cell.config.Umts>,
    UmtsG
{
     ...
     *
     *
     * @return <code>org.opendaylight.yang.gen.v1.urn.onf.otcc.wireless.yang.radio.access.rev180408.fap.service.cell.config.umts.UmtsCn</code> <code>umtsCn</code>, or <code>null</code> if not present
     */
    UmtsCn getUmtsCn();
     ...
     *
     *
     * @return <code>org.opendaylight.yang.gen.v1.urn.onf.otcc.wireless.yang.radio.access.rev180408.fap.service.cell.config.umts.UmtsRan</code> <code>umtsRan</code>, or <code>null</code> if not present
     */
    UmtsRan getUmtsRan();
     ...
     *
     *
     * @return <code>org.opendaylight.yang.gen.v1.urn.onf.otcc.wireless.yang.radio.access.rev180408.fap.service.cell.config.umts.UmtsRab</code> <code>umtsRab</code>, or <code>null</code> if not present
     */
    UmtsRab getUmtsRab();
