...
public class TimeXStatesListKey
 implements Identifier<TimeXStatesList> {
    ...
    public java.lang.String toString() {
        java.lang.StringBuilder builder = new java.lang.StringBuilder(org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev180907.air._interface.performance.type.g.TimeXStatesListKey.class.getSimpleName()).append(" [");
        boolean first = true;
