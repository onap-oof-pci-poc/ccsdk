 ...
 * <i>microwave-model/wire-interface-current-performance-type-g</i>
 *
 */
public interface WireInterfaceCurrentPerformanceTypeG
    extends
    DataObject,
    OtnCurrentDataG
{
    ...
    public static final QName QNAME = org.opendaylight.yangtools.yang.common.QName.create("urn:onf:params:xml:ns:yang:microwave-model",
        "2018-10-10", "wire-interface-current-performance-type-g").intern();
     ...
     *
     *
     * @return <code>org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev181010.wire._interface.current.performance.type.g.PerformanceData</code> <code>performanceData</code>, or <code>null</code> if not present
     */
