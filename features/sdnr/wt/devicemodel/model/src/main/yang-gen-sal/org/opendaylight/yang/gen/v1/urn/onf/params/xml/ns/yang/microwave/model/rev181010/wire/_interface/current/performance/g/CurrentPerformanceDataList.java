...
import org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev181010.WireInterfaceCurrentPerformanceTypeG;
 ...
 * <i>microwave-model/wire-interface-current-performance-g/current-performance-data-list</i>
 *
...
public interface CurrentPerformanceDataList
    extends
    ChildOf<WireInterfaceCurrentPerformanceG>,
    Augmentable<org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev181010.wire._interface.current.performance.g.CurrentPerformanceDataList>,
    WireInterfaceCurrentPerformanceTypeG,
    Identifiable<CurrentPerformanceDataListKey>
{
     ...
     *
     *
     * @return <code>org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev181010.wire._interface.current.performance.g.CurrentPerformanceDataListKey</code> <code>key</code>, or <code>null</code> if not present
     */
