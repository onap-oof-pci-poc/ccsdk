 ...
 * <i>microwave-model/air-interface-current-problem-type-g</i>
 *
 */
public interface AirInterfaceCurrentProblemTypeG
    extends
    DataObject,
    MwCurrentProblemG
{
    ...
    public static final QName QNAME = org.opendaylight.yangtools.yang.common.QName.create("urn:onf:params:xml:ns:yang:microwave-model",
        "2018-09-07", "air-interface-current-problem-type-g").intern();
