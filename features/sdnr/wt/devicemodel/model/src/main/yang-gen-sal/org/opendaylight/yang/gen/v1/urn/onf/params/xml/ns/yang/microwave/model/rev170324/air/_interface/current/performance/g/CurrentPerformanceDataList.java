...
import org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev170324.AirInterfaceCurrentPerformanceG;
...
public interface CurrentPerformanceDataList
    ...
    Augmentable<org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev170324.air._interface.current.performance.g.CurrentPerformanceDataList>,
    ...
    Identifiable<CurrentPerformanceDataListKey>
{
     ...
     *
     *
     * @return <code>org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev170324.air._interface.current.performance.g.CurrentPerformanceDataListKey</code> <code>key</code>, or <code>null</code> if not present
     */
