 ...
 * {{object|.CellConfig.CDMA2000.HRPD.BatchPCFPDSN.{i}.}} table should be used to 
 ...
 * <i>bbf-tr-196-2-0-3-full/cdma2000-hrpd-pcfpdsn-g</i>
 *
 */
public interface Cdma2000HrpdPcfpdsnG
    extends
    DataObject
{
    ...
    public static final QName QNAME = org.opendaylight.yangtools.yang.common.QName.create("urn:onf:otcc:wireless:yang:radio-access",
        "2018-04-08", "cdma2000-hrpd-pcfpdsn-g").intern();
     ...
     * PDSN number in PDSN selection algorithm (refer to {{bibref|3GPP2-A.S0008}} and 
     ...
     *
     *
     * @return <code>org.opendaylight.yang.gen.v1.urn.onf.otcc.wireless.yang.radio.access.rev180408.Cdma2000HrpdPcfpdsnG.IosVersion</code> <code>iosVersion</code>, or <code>null</code> if not present
     */
