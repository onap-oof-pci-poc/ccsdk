 ...
 * <i>bbf-tr-196-2-0-3-full/capabilities-cdma2000-one-x-self-config-g</i>
 *
 */
public interface CapabilitiesCdma2000OneXSelfConfigG
    extends
    DataObject
{
    ...
    public static final QName QNAME = org.opendaylight.yangtools.yang.common.QName.create("urn:onf:otcc:wireless:yang:radio-access",
        "2018-04-08", "capabilities-cdma2000-one-x-self-config-g").intern();
     ...
     * provided in {{param|.CellConfig.CDMA2000.OneX.RAN.RF.RFCNFL}} for the FAP to 
     ...
     * MAY be provided in {{param|.CellConfig.CDMA2000.OneX.RAN.RF.PilotPN}} for the 
     ...
     * provided in {{param|.CellConfig.CDMA2000.OneX.RAN.RF.MaxFAPTxPower}} for the FAP
