...
public interface SegmentsIdList
    ...
    Augmentable<org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev170324.ethernet.container.configuration.g.SegmentsIdList>,
    SegmentIdTypeG,
    Identifiable<SegmentsIdListKey>
{
    ...
    public static final QName QNAME = org.opendaylight.yangtools.yang.common.QName.create("urn:onf:params:xml:ns:yang:microwave-model",
        "2017-03-24", "segments-id-list").intern();
     ...
     *
     *
     * @return <code>org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev170324.ethernet.container.configuration.g.SegmentsIdListKey</code> <code>key</code>, or <code>null</code> if not present
     */
