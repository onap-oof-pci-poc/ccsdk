...
/**
 * This object contains parameters relating to the SRB2 (Signaling Radio Bearer 2) 
 ...
 * <i>bbf-tr-196-2-0-3-full/lte-ran-rlc-srb2-g</i>
 *
 */
public interface LteRanRlcSrb2G
    extends
    DataObject
{
    ...
    public static final QName QNAME = org.opendaylight.yangtools.yang.common.QName.create("urn:onf:otcc:wireless:yang:radio-access",
        "2018-04-08", "lte-ran-rlc-srb2-g").intern();
     ...
     * in milliseconds, with a numeric range between 5 and 500 inclusive. Only the 
     * multiple of 5 are valid in the range between 5 and 250 inclusive (i.e. 5, 10, 
     * 15, 20,... 250), and only the multiple of 50 are valid in the range between 300 
     * and 500 inclusive (i.e., 300, 350, 400, 450, 500). If the value is other than 
     * these, the CPE MUST reject the value. In case there is more than one item in the
     ...
     * to {{false}}. Corresponds to t-PollRetransmit IE specified in 
     * {{bibref|3GPP-TS.36.331|Section 6.3.2}} and in {{bibref|3GPP-TS.36.322|Section 
     * 5.2.2}}. The multiplicity of the {{param}} values can also be expressed by 
