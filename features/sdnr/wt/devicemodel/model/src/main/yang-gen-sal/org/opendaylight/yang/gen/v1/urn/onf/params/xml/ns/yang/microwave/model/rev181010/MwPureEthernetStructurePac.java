...
public interface MwPureEthernetStructurePac
    ...
    Augmentable<org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev181010.MwPureEthernetStructurePac>,
    Identifiable<MwPureEthernetStructurePacKey>
{
    ...
    public static final QName QNAME = org.opendaylight.yangtools.yang.common.QName.create("urn:onf:params:xml:ns:yang:microwave-model",
        "2018-10-10", "mw-pure-ethernet-structure-pac").intern();
     ...
     *
     *
     * @return <code>org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev181010.mw.pure.ethernet.structure.pac.PureEthernetStructureCapability</code> <code>pureEthernetStructureCapability</code>, or <code>null</code> if not present
     */
     ...
     *
     *
     * @return <code>org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev181010.mw.pure.ethernet.structure.pac.PureEthernetStructureConfiguration</code> <code>pureEthernetStructureConfiguration</code>, or <code>null</code> if not present
     */
     ...
     *
     *
     * @return <code>org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev181010.mw.pure.ethernet.structure.pac.PureEthernetStructureStatus</code> <code>pureEthernetStructureStatus</code>, or <code>null</code> if not present
     */
     ...
     *
     *
     * @return <code>org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev181010.mw.pure.ethernet.structure.pac.PureEthernetStructureCurrentProblems</code> <code>pureEthernetStructureCurrentProblems</code>, or <code>null</code> if not present
     */
     ...
     *
     *
     * @return <code>org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev181010.mw.pure.ethernet.structure.pac.PureEthernetStructureCurrentPerformance</code> <code>pureEthernetStructureCurrentPerformance</code>, or <code>null</code> if not present
     */
     ...
     *
     *
     * @return <code>org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev181010.mw.pure.ethernet.structure.pac.PureEthernetStructureHistoricalPerformances</code> <code>pureEthernetStructureHistoricalPerformances</code>, or <code>null</code> if not present
     */
     ...
     *
     *
     * @return <code>org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev181010.MwPureEthernetStructurePacKey</code> <code>key</code>, or <code>null</code> if not present
     */
