 ...
 * <i>bbf-tr-196-2-0-3-full/cdma2000-one-x-redirect-g</i>
 *
 */
public interface Cdma2000OneXRedirectG
    extends
    DataObject
{
    ...
    public static final QName QNAME = org.opendaylight.yangtools.yang.common.QName.create("urn:onf:otcc:wireless:yang:radio-access",
        "2018-04-08", "cdma2000-one-x-redirect-g").intern();

    /**
     * The channel number set from ACS that the FAP uses to redirect the MS in case of 
    ...
    /**
     * The bandclass set from ACS that the FAP uses to redirect the MS incase of closed
     ...
     * configured, the FAP rejects the MS. The supported range is 0..9.
     *
     *
     *
