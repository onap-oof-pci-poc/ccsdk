 ...
 * <i>onf-core-model-conditional-packages/connector-current-problems-g/current-problem-list</i>
 *
...
public interface CurrentProblemList
    extends
    ChildOf<ConnectorCurrentProblemsG>,
    Augmentable<org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.onf.core.model.conditional.packages.rev170402.connector.current.problems.g.CurrentProblemList>,
    CurrentProblemTypeG,
    Identifiable<CurrentProblemListKey>
{
     ...
     *
     *
     * @return <code>org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.onf.core.model.conditional.packages.rev170402.connector.current.problems.g.CurrentProblemListKey</code> <code>key</code>, or <code>null</code> if not present
     */
