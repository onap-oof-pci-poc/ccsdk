 ...
 * <i>onf-core-model-conditional-packages/equipment-current-problems-g</i>
 *
 */
public interface EquipmentCurrentProblemsG
    extends
    DataObject
{
    ...
    public static final QName QNAME = org.opendaylight.yangtools.yang.common.QName.create("urn:onf:params:xml:ns:yang:onf-core-model-conditional-packages",
        "2017-04-02", "equipment-current-problems-g").intern();
