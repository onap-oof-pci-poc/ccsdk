...
import org.opendaylight.yang.gen.v1.urn.onf.otcc.wireless.yang.radio.access.rev180408.LteRanG;
 ...
 * <i>bbf-tr-196-2-0-3-full/fap-service/cell-config/lte/lte-ran</i>
 *
 * <p>To create instances of this class use {@link LteRanBuilder}.
 * @see LteRanBuilder
 *
 */
public interface LteRan
    extends
    ChildOf<Lte>,
    Augmentable<org.opendaylight.yang.gen.v1.urn.onf.otcc.wireless.yang.radio.access.rev180408.fap.service.cell.config.lte.LteRan>,
    LteRanG
{
     ...
     *
     *
     * @return <code>org.opendaylight.yang.gen.v1.urn.onf.otcc.wireless.yang.radio.access.rev180408.fap.service.cell.config.lte.lte.ran.LteRanCommon</code> <code>lteRanCommon</code>, or <code>null</code> if not present
     */
    LteRanCommon getLteRanCommon();
     ...
     *
     *
     * @return <code>org.opendaylight.yang.gen.v1.urn.onf.otcc.wireless.yang.radio.access.rev180408.fap.service.cell.config.lte.lte.ran.LteRanS1Ap</code> <code>lteRanS1Ap</code>, or <code>null</code> if not present
     */
    LteRanS1Ap getLteRanS1Ap();
     ...
     *
     *
     * @return <code>org.opendaylight.yang.gen.v1.urn.onf.otcc.wireless.yang.radio.access.rev180408.fap.service.cell.config.lte.lte.ran.LteRanS1U</code> <code>lteRanS1U</code>, or <code>null</code> if not present
     */
    LteRanS1U getLteRanS1U();
     ...
     *
     *
     * @return <code>org.opendaylight.yang.gen.v1.urn.onf.otcc.wireless.yang.radio.access.rev180408.fap.service.cell.config.lte.lte.ran.LteRanRf</code> <code>lteRanRf</code>, or <code>null</code> if not present
     */
    LteRanRf getLteRanRf();
     ...
     *
     *
     * @return <code>org.opendaylight.yang.gen.v1.urn.onf.otcc.wireless.yang.radio.access.rev180408.fap.service.cell.config.lte.lte.ran.LteRanPhy</code> <code>lteRanPhy</code>, or <code>null</code> if not present
     */
    LteRanPhy getLteRanPhy();
     ...
     *
     *
     * @return <code>org.opendaylight.yang.gen.v1.urn.onf.otcc.wireless.yang.radio.access.rev180408.fap.service.cell.config.lte.lte.ran.LteRanMac</code> <code>lteRanMac</code>, or <code>null</code> if not present
     */
    LteRanMac getLteRanMac();
     ...
     *
     *
     * @return <code>org.opendaylight.yang.gen.v1.urn.onf.otcc.wireless.yang.radio.access.rev180408.fap.service.cell.config.lte.lte.ran.LteRanRlc</code> <code>lteRanRlc</code>, or <code>null</code> if not present
     */
    LteRanRlc getLteRanRlc();
     ...
     *
     *
     * @return <code>org.opendaylight.yang.gen.v1.urn.onf.otcc.wireless.yang.radio.access.rev180408.fap.service.cell.config.lte.lte.ran.LteRanRrcTimers</code> <code>lteRanRrcTimers</code>, or <code>null</code> if not present
     */
    LteRanRrcTimers getLteRanRrcTimers();
     ...
     *
     *
     * @return <code>org.opendaylight.yang.gen.v1.urn.onf.otcc.wireless.yang.radio.access.rev180408.fap.service.cell.config.lte.lte.ran.LteRanCellRestriction</code> <code>lteRanCellRestriction</code>, or <code>null</code> if not present
     */
    LteRanCellRestriction getLteRanCellRestriction();
     ...
     *
     *
     * @return <code>org.opendaylight.yang.gen.v1.urn.onf.otcc.wireless.yang.radio.access.rev180408.fap.service.cell.config.lte.lte.ran.LteRanMobility</code> <code>lteRanMobility</code>, or <code>null</code> if not present
     */
    LteRanMobility getLteRanMobility();
     ...
     *
     *
     * @return <code>org.opendaylight.yang.gen.v1.urn.onf.otcc.wireless.yang.radio.access.rev180408.fap.service.cell.config.lte.lte.ran.LteRanNeighborList</code> <code>lteRanNeighborList</code>, or <code>null</code> if not present
     */
    LteRanNeighborList getLteRanNeighborList();
     ...
     *
     *
     * @return <code>org.opendaylight.yang.gen.v1.urn.onf.otcc.wireless.yang.radio.access.rev180408.fap.service.cell.config.lte.lte.ran.LteRanNeighborListInUse</code> <code>lteRanNeighborListInUse</code>, or <code>null</code> if not present
     */
    LteRanNeighborListInUse getLteRanNeighborListInUse();
