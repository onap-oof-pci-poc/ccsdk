...
public interface SupportedTdmStructureTypesList
    ...
    Augmentable<org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev181010.hybrid.mw.structure.capability.g.SupportedTdmStructureTypesList>,
    TdmStructureTypeG,
    Identifiable<SupportedTdmStructureTypesListKey>
{
    ...
    public static final QName QNAME = org.opendaylight.yangtools.yang.common.QName.create("urn:onf:params:xml:ns:yang:microwave-model",
        "2018-10-10", "supported-tdm-structure-types-list").intern();
     ...
     *
     *
     * @return <code>org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev181010.hybrid.mw.structure.capability.g.SupportedTdmStructureTypesListKey</code> <code>key</code>, or <code>null</code> if not present
     */
