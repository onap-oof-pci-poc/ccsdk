...
public interface MwTdmContainerPac
    ...
    Augmentable<org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev170324.MwTdmContainerPac>,
    Identifiable<MwTdmContainerPacKey>
{
    ...
    public static final QName QNAME = org.opendaylight.yangtools.yang.common.QName.create("urn:onf:params:xml:ns:yang:microwave-model",
        "2017-03-24", "mw-tdm-container-pac").intern();
     ...
     *
     *
     * @return <code>org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev170324.mw.tdm.container.pac.TdmContainerCapability</code> <code>tdmContainerCapability</code>, or <code>null</code> if not present
     */
     ...
     *
     *
     * @return <code>org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev170324.mw.tdm.container.pac.TdmContainerConfiguration</code> <code>tdmContainerConfiguration</code>, or <code>null</code> if not present
     */
     ...
     *
     *
     * @return <code>org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev170324.mw.tdm.container.pac.TdmContainerStatus</code> <code>tdmContainerStatus</code>, or <code>null</code> if not present
     */
     ...
     *
     *
     * @return <code>org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev170324.mw.tdm.container.pac.TdmContainerCurrentProblems</code> <code>tdmContainerCurrentProblems</code>, or <code>null</code> if not present
     */
     ...
     *
     *
     * @return <code>org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev170324.mw.tdm.container.pac.TdmContainerCurrentPerformance</code> <code>tdmContainerCurrentPerformance</code>, or <code>null</code> if not present
     */
     ...
     *
     *
     * @return <code>org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev170324.mw.tdm.container.pac.TdmContainerHistoricalPerformances</code> <code>tdmContainerHistoricalPerformances</code>, or <code>null</code> if not present
     */
     ...
     *
     *
     * @return <code>org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev170324.MwTdmContainerPacKey</code> <code>key</code>, or <code>null</code> if not present
     */
