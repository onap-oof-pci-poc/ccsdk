...
public class ArchivCleanService implements AutoCloseable, IConfigChangedListener, Runnable {

    private static final Logger LOG = LoggerFactory.getLogger(ArchivCleanService.class);
    ...
    public ArchivCleanService(HtDevicemanagerConfiguration config, ArchiveCleanProvider... indexCleanList) {
    ...
    public void onConfigChanged() {
        ...
        ArchivCleanService.this.config = EsConfig.reload();
        ArchivCleanService.this.reinit();
    };
