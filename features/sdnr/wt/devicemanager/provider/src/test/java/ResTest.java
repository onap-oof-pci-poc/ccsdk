...
public class ResTest {
    ...
    private static void testDuplicateKeyJSON() {
        try {
            String str =
                    Resources.getFileContent("/elasticsearch/index/mwtn/modelDescription/CoreModel-ForMicrowave.json");
                ...
                public JSONObject putOnce(String key, Object value) throws JSONException {
                    ...
                    if (key != null && value != null) {
                        if ((storedValue = this.opt(key)) != null) {
                            if (!storedValue.equals(value)) { // Only through Exception for different values with same
                                                              // key
                                // Replace
