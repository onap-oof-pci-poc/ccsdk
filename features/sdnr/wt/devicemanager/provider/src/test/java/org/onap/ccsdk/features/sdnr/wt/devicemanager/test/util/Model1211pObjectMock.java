...
public class Model1211pObjectMock {
    ...
    public static NetconfNode getNetconfNode() {
        ...
        AvailableCapabilitiesBuilder availableCapabilitiesBuilder =
                getAvailableCababilitiesList(NetworkElement.QNAME, WrapperMicrowaveModelRev181010.QNAME);
    ...
    private static Extension getExtension(String key, String valueName, String value) {
        ExtensionBuilder lpExtension = new ExtensionBuilder();
        lpExtension.withKey(new ExtensionKey(key));
    ...
    private static Ltp getLtp(Class<?> clazz, QName qname, ONFLayerProtocolName onflayerProtocolName) {
        ...
        lpBuilder.setExtension(Arrays.asList(getExtension(extensionKey, "capability", qname.getLocalName()),
                getExtension(extensionKey, "revision", qname.getRevision().get().toString()),
                getExtension(extensionKey, "conditional-package", qname.getModule().toString())));
