...
import org.opendaylight.yang.gen.v1.org.onap.ccsdk.features.sdnr.northbound.goodbyeworld.rev150105.GreetingInput;
import org.opendaylight.yang.gen.v1.org.onap.ccsdk.features.sdnr.northbound.goodbyeworld.rev150105.GreetingInputBuilder;
import org.opendaylight.yang.gen.v1.org.onap.ccsdk.features.sdnr.northbound.goodbyeworld.rev150105.GreetingOutput;
import org.opendaylight.yang.gen.v1.org.onap.ccsdk.features.sdnr.northbound.goodbyeworld.rev150105.GreetingOutputBuilder;
...
public class GoodbyeworldProvider implements GoodbyeworldService, AutoCloseable {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(GoodbyeworldProvider.class);

    private final String appName = "Goodbyeworld";

    private final DataBroker dataBroker;
    private final RpcProviderRegistry rpcProviderRegistry;
    private RpcRegistration<GoodbyeworldService> serviceRegistration;


    public GoodbyeworldProvider(final DataBroker dataBroker, RpcProviderRegistry rpcProviderRegistry) {
     ...
     */
    public void init() {
        serviceRegistration = rpcProviderRegistry.addRpcImplementation(GoodbyeworldService.class, this);
    ...
    public ListenableFuture<RpcResult<GreetingOutput>> greeting(GreetingInput input) {
        ...
        if (soFarSoGood) {
            responseBuilder.setResponse("Goodbye " + input.getSalutation());
